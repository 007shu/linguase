...
public class GermanQuizActivity extends AppCompatActivity {
    ...
    private String[][] options = {
            {"London", "Berlin", "Madrid", "Rom"},
            {"Apfel", "Orange", "Banane", "Traube"}
    };
    ...
    private MappedByteBuffer loadModelFile() throws IOException {
        AssetFileDescriptor fileDescriptor = getAssets().openFd("model_german.tflite");
