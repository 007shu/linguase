...
public class FrenchQuizActivity extends AppCompatActivity {
    ...
    private MappedByteBuffer loadModelFile() throws IOException {
        AssetFileDescriptor fileDescriptor = getAssets().openFd("model_french.tflite");
    ...
    private void checkAnswer() {
        ...
        if (selectedAnswer.equals(correctAnswer)) {
            questionTextView.setText("Bonne réponse !");
        } else {
            questionTextView.setText("Mauvaise réponse. Réessayez.");
        }
