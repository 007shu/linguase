...
public class JapaneseCrosswordGridAdapter extends BaseAdapter {
    private Context context;
    private String[][] grid;
    private EditText[][] inputCells;
    private SharedPreferences prefs;

    public JapaneseCrosswordGridAdapter(Context context, String[][] grid, SharedPreferences prefs) {
    ...
    public JapaneseCrosswordGridAdapter() {
